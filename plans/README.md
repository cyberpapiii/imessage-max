...
| 060 | CI hang: `swift test --parallel` on macos-26 never finishes | P0 | S | 059 | DONE 2026-09-01, merged to main (`0906f04`, branch `advisor/060-ci-hang-4`; 370/0). Serial CI. Parallel cannot work here: SessionManager cleanup `AsyncTimeout.sleep` uses `asyncAfter`; cancelled items stay until the 300s deadline and pin every worker (5m03s gaps in 33571807330 / 33573110364). `timeout-minutes: 15` kept. |
