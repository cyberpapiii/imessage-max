...
Executor handoff plans generated by the improve skill.
...
Deploying to the local launchd service (`make install`) is an operator
action, not an executor step.

## Current (2026-09-03): search hang
