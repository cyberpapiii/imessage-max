...
| 060 | CI hang: `swift test --parallel` on macos-26 stuck in `testFullVariantOversizeFallsBackToVisionSize` | P0 | S | 059 | DONE 2026-09-01, merged to main (`a98c065`, branch `advisor/060-ci-hang`; 368/0). Follow-up `35b3d63` (`advisor/060-ci-hang-2`; 370/0): do not call `process()` on a SOF-spoofed 50MP header; ImageIO thumbnails from SOF and hung the runner for 12 minutes. `timeout-minutes: 15` kept. |
