...
| 085 | Stage `send` attachments through a symlink-safe file handle into a 0700 directory (lstat every component, trusted `/tmp` `/var` `/etc` aliases) | P1 | M | none | DONE 2026-09-02, branch `advisor/085-symlink-safe-attachment-staging`; 447/0 (436 + 11). Symlink/TOCTOU tests use `temporaryDirectory` scratch only. Step 6 Messages probe skipped (optional). |
