...
| 017 | Agent-native send contract (remove elicitation; narrow the gate) | P1 | M | 015 | TODO (planned 2026-06-11 at `4427cef`; operator decision: send must be synchronous and truthful — no popup waits; gate = groups/files/long texts, instant `pending_confirmation`, `confirm: true` as the explicit flag) |
