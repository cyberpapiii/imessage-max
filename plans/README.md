...
| 017 | Agent-native send contract (remove the confirmation gate and elicitation) | P1 | M | 015 | TODO (v2 planned 2026-06-11; operator decision: the gate is removed ENTIRELY, not narrowed — an agent-set boolean is not a safety mechanism, harness tool-approval is the human checkpoint, and ambiguity/validation refusal plus post-send verification carry the safety; `confirm` stays in the schema as an inert deprecated param) |
