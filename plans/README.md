...
| 081 | Probe the chat.db schema at open; `SchemaCapabilities` flags guard `thread_originator_guid`, `date_edited`, `associated_message_emoji`; `database.features` in diagnose | P2 | M | 082 (shared Diagnose edits) | DONE 2026-09-02, branch `advisor/081-schema-capability-flags`. Guarded only the three columns. |
